...
/// <summary>Identifies a portable result returned by the native NeoAstra runtime.</summary>
...
public enum NeoSupportLevel
{
    ...
    Native = 1,
    /// <summary>NeoAstra emulates the capability.</summary>
    Emulated = 2,
...
public enum NeoBridgePolicy : uint
{
    ...
    /// <see cref="NeoAstraOptions.BridgeOrigins"/>. This mode is unavailable on Linux because
    /// WebKitGTK 6.0 does not expose trustworthy script-message sender origins.
    /// </summary>
    TrustedOrigins = 1,
...
/// NeoAstra object remains alive, must be used on the appropriate UI thread, and must not be released.
/// </summary>
