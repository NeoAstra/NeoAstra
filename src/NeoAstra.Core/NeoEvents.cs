...
{
    private readonly NeoAstra _opener;
    ...
    public ValueTask<NeoAstra> CreateViewAsync(NeoAstraHost host, NeoAstraOptions? options = null, CancellationToken cancellationToken = default)
    {
...
public readonly record struct NeoNewWindowDecision(NeoDecisionAction Action, NeoAstra? TargetView = null)
{
    ...
    public static NeoNewWindowDecision UseView(NeoAstra view)
    {
