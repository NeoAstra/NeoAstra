...
public sealed class DeliveryTests
{
    ...
    public void BundleConfigurationAndStagingAreStrictDeterministicAndRedacted()
    {
        ...
        if (OperatingSystem.IsWindows()) { StringAssert.Contains(platformInput, "MinVersion=\"10.0.0.0\""); StringAssert.Contains(platformInput, "Publisher=\"CN=Unsigned\""); StringAssert.Contains(platformInput, "runFullTrust"); }
    }
