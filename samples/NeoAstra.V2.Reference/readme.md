# NeoAstra v2 Feature Tour

`NeoAstra.V2.Reference` is the maintained advanced sample for the application-platform work in
[`doc/neoastra_v2_specs.md`](../../doc/neoastra_v2_specs.md). It uses a normal React/Vite frontend and
...
```powershell
dotnet run --project samples/NeoAstra.V2.Reference/NeoAstra.V2.Reference.csproj
```

In Visual Studio, set `NeoAstra.V2.Reference` as the startup project and run it without command-line
...
```powershell
cd samples/NeoAstra.V2.Reference/ClientApp
npm install
npm run dev
```
...
```powershell
dotnet run --project samples/NeoAstra.V2.Reference -- --validate-reference
dotnet publish samples/NeoAstra.V2.Reference/NeoAstra.V2.Reference.csproj `
