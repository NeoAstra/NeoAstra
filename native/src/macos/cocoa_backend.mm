    ...
    @autoreleasepool {
        @try {
            try {
                ...
                [configuration.userContentController addScriptMessageHandler:state->delegate name:@"neoastra"];
