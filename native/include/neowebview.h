...
typedef enum neo_webview_bridge_policy : uint32_t { NEO_WEBVIEW_BRIDGE_DISABLED = 0, NEO_WEBVIEW_BRIDGE_TRUSTED_ORIGINS = 1, NEO_WEBVIEW_BRIDGE_TRUST_ENTIRE_VIEW = 2 } neo_webview_bridge_policy_t;
