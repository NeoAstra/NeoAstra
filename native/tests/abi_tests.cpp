...
static_assert(NEO_WEBVIEW_DECISION_FULLSCREEN == 9);
...
static_assert(NEO_WEBVIEW_EVENT_WEB_PROCESS_TERMINATED == 29);
static_assert(NEO_WEBVIEW_CAPABILITY_ZOOM == 25);
...
static_assert(sizeof(void*) == 8, "ABI 1.5 targets the current 64-bit primary platforms");
...
static_assert(sizeof(neo_webview_event_t) == 96 && offsetof(neo_webview_event_t, decision) == 88);
...
static_assert(sizeof(neo_webview_view_options_t) == 80 && offsetof(neo_webview_view_options_t, decision_timeout_ms) == 72);
static_assert(sizeof(neo_webview_script_options_t) == 40 && offsetof(neo_webview_script_options_t, world_name) == 24);
static_assert(sizeof(neo_webview_decision_response_t) == 48 && offsetof(neo_webview_decision_response_t, paths) == 32);
